...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00C8FF&center=true&vCenter=true&width=600&lines=Backend+%26+AI+Engineer;MCP+%7C+LangGraph+%7C+Graph+RAG+Builder;CS+Undergrad+%40+NIT+Kurukshetra+%2727;)](https://git.io/typing-svg)
...
<p>
  ...
  <a href="https://smithery.ai/servers/labsofuniverse/legacy-mcp-analyzer">
    <img src="https://img.shields.io/badge/Smithery-MCP%20Published-green?style=for-the-badge&logo=anthropic&logoColor=white" />
  </a>
</p>
...
-  **CodeChef:** 3-Star Rated Competitive Programmer.
...
![FastMCP](https://img.shields.io/badge/FastMCP-MCP%20Protocol-6236FF?style=flat-square)
...
![Graph RAG](https://img.shields.io/badge/Graph%20RAG-Knowledge%20Graph-blueviolet?style=flat-square)
![Agentic AI](https://img.shields.io/badge/Agentic%20AI-Multi--Agent-orange?style=flat-square)
![MCP Protocol](https://img.shields.io/badge/MCP-Model%20Context%20Protocol-green?style=flat-square)
![Vector Search](https://img.shields.io/badge/Vector%20Search-Semantic%20RAG-blue?style=flat-square)
...
`JavaScript` `AI Tooling` `Markdown` `Context Management`
...
`Python` `tree-sitter` `NetworkX` `FastMCP` `Graph RAG` `JSON-RPC` `GCP` `Smithery`
...
`FastAPI` `RAG` `OCR` `Elasticsearch` `GCP` `Vector Search`

---

###  SmartMarket AI Assistant *(@ Lepton Software)*
> **Autonomous Multi-Agent System for Conversational Data Analysis**

Built during internship — an agentic AI assistant powered by **LangGraph** that orchestrates multi-step reasoning across distributed APIs and databases. Enabled non-technical users to query complex data through natural language.

`LangGraph` `LangChain` `FastAPI` `Multi-Agent` `PostgreSQL`
...
I'm always open to discussing **backend architecture**, **AI agent design**, or just geeking out over **distributed systems**. If you're building something interesting or have an opportunity in mind — reach out!
...
<div align="center">
  <i>"Build systems that outlive the context window."</i>
</div>
